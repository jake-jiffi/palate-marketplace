...
Hand to `/palate-beta:publish`. It runs the contract, heals, commits, deploys, rebuilds the index and
...
page: `/palate-beta:rollback`. That takes the whole site back with it, including every other change
