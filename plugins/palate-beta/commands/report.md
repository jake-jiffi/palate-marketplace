...
# what was caught (written by /palate-beta:check)
...
1. /services has failed contrast three months running. Fix the token, not the page:
   --ink-muted is 4.35:1 on ivory and needs 4.5:1.        /palate-beta:check after
2. Nothing published since 2026-06-30. The blog is the reason this site has a
   content runtime.
3. Two orphans are now three months old (/v1, /lp2). Link them or delete them.  /palate-beta:sweep
```
