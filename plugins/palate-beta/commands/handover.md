...
> Dry run. Nothing moved. Run `/palate-beta:handover <owner> <email>` to do it for real.
...
- Checks before publishing, in Claude Code: `/palate-beta:check`
...
> It is yours, and it is building. `/palate-beta:check` still works with no account.
